...
# MongoDB connection — internal docker network: mongodb://mongo:27017
...
async def health():
    """Container healthcheck endpoint — must return 200 for Coolify to consider the backend ready."""
    try:
